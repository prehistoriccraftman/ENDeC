...
function listbox:draw()
	...
	if self.expand then lg.rectangle("fill", self.x+self.w, self.y+self.h,self.expx,self.expx,self.rsize,self.rsize) end
	...
	if self.expand then lg.rectangle("line", self.x+self.w, self.y+self.h,self.expx,self.expx,self.rsize,self.rsize) end
