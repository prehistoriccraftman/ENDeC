...
function canvas.create(pName, pX, pY, pRotate, pScaleX, pScaleY, pWidth, pHeight, pRed, pGreen, pBlue, pAlpha, pBlendMode)
  print(pName, pX, pY, pRotate, pScaleX, pScaleY, pWidth, pHeight, pRed, pGreen, pBlue, pAlpha, pBlendMode)
  local new = {preload=preload, start=start, finish=finish, updateDraw=updateDraw, update=function(self)end, draw=draw}
    new.name = pName
    new.x = pX
    new.y = pY
    new.rotate = pRotate
